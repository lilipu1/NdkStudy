...
/* $Id: include.lame.c,v 1.377 2017/09/26 12:14:02 robert Exp $ */
...
lame_init_params(lame_global_flags * gfp)
{
    ...
    /* start updating include.lame internal flags */
...
#endif
    /* updating include.lame internal flags finished successful */
...
lame_init_internal_flags(lame_internal_flags* gfc)
{
    ...
    if (NULL == gfc->ATH)
        return -2;      /* maybe error codes should be enumerated in include.lame.h ?? */
...
lame_init_old(lame_global_flags * gfp)
{
    ...
    /* see include.lame.h for description */
