/*
 *      include.lame utility library include file
 *
...
#  define  LAME_ID   0xFFF88E3B
        ...
        /* variables used by include.lame.c */
        Bit_stream_struc bs;
...
/* same as lame_decode1 (look in include.lame.h), but returns
   unclipped raw floating-point samples. It is declared
   here, not in include.lame.h, because it returns LAME's
