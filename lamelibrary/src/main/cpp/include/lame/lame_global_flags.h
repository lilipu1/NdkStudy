...
struct lame_global_struct {
    ...
    int     decode_only;     /* use include.lame/mpglib to convert mp3 to wav       */
    int     quality;         /* quality setting 0=best,  9=worst  default=5 */
    MPEG_mode mode;          /* see enum in include.lame.h
                                default = LAME picks best value             */
    ...
    int     lowpassfreq;     /* freq in Hz. 0=include.lame choses.
                                -1=no filter                          */
    int     highpassfreq;    /* freq in Hz. 0=include.lame choses.
                                -1=no filter                          */
